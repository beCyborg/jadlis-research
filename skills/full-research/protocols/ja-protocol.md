...
| `mcp__plugin_jadlis-research_brave-search__brave_web_search` | discovery in Japanese: `site:qiita.com 個人開発 収益`, `site:note.com …`, `site:zenn.dev …` — Brave returns Japanese pages only for a Japanese query |
